...
public open class ReadableNativeArray protected constructor(hybridData: HybridData?) :
  ...
  override fun getBoolean(index: Int): Boolean = localArray[index] as? Boolean ?: false

  override fun getDouble(index: Int): Double = localArray[index] as? Double ?: 0.0

  override fun getInt(index: Int): Int = getDouble(index).toInt()

  override fun getLong(index: Int): Long = localArray[index] as? Long ?: 0L
